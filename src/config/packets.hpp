 ...
 **/
	...
	// #ifndef PACKET_OBFUSCATION // Tkap: disabled this
		// #define PACKET_OBFUSCATION // Tkap: disabled this
		...
		// #define PACKET_OBFUSCATION_WARN // Tkap: disabled this
	// #endif // Tkap: disabled this
#else
